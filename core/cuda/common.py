...
class KernelHelper:
    ...
    def getGlobal(self, name):
        return checkCudaErrors(cuda.cuModuleGetGlobal(self.module, name))

    def getTexRef(self, name):
        return checkCudaErrors(cuda.cuModuleGetTexRef(self.module, name))

    def getSurfRef(self, name):
        return checkCudaErrors(cuda.cuModuleGetSurfRef(self.module, name))
